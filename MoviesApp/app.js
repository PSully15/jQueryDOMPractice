...
$(function () {
	...
	// when the delete button is clicked, remove the closest parent tr and remove
	// from the array of movies
...
// createMovieDataHTML accepts an object with title and rating keys and returns a
// string of HTML
